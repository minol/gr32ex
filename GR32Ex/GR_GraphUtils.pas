 ...
 * License.
 *
 * The Original Code is GR_GraphUtils
 *
...
type
  { Summary For Easy visit the Color32 RGBA elements}
  { Description
    @param rgbBlue  Blue
    @param rgbGreen Green
    @param rgbRed   Red
    @param rgbAlpha Alpha

    you can use typecasts to visit the RGB of the TColor32, eg:
     TColor32Rec(aColor32).rgbBlue := 11;
  }
  ...
  { Summary Simple Color Frame(Border) Style}
...
{ Summary Convert RGB color to Hue(色调), Saturation(饱和度) and Luminance(亮度)}
